...
while True:
    ...
    if command == "balance":
        ...
        if balance == "add":
            ...
            print(f"You have successfully added {add} $ to your account balance, your account balance is now {account_balance} $.\n")
            ...
            if (account_balance-subtract) > 0:
                account_balance = round(account_balance,2)
                print(f"You have successfully subtracted {subtract} $ from your account balance, your account balance is now {account_balance} $.\n")
